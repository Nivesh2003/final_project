...
from .views import home, registration,login,video_feed,dashboard,exam_submission_success,exam,submit_exam,result,record_tab_switch,get_warning,add_question,update_question,delete_question,update_test_subject
from django.conf import settings
from django.conf.urls.static import static
...
urlpatterns = [
    ...
    path('admin_dashboard/update_question/<int:question_id>/', update_question, name='update_question'),
    path('admin_dashboard/delete_question/<int:question_id>/', delete_question, name='delete_question'),
    path('admin_dashboard/update_subject/', update_test_subject, name='update_test_subject'),
